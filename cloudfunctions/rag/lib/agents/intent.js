...
function deterministicIntent(query, safety) {
  ...
  if (/截止|报名时间|什么时候|哪一场|下一场|最近一场|几点|日期|近期|即将|开始时间/.test(text)) return { route: 'upcoming', intent: 'deadline_or_schedule', keywords, category, timeSensitive: true, requiresLogin: false, tools: ['current_time', 'public_database'] }

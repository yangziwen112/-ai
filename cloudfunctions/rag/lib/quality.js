...
function evaluateAnswer(state, answer) {
  ...
  const actionable = route === 'social_chat' || route === 'time' || route === 'unsafe' || route === 'account_action'
    ? true
